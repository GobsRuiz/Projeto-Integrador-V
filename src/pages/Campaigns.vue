<template>
  <q-page class="q-py-xl">
    <h1 id="campaigns-title" class="text-h3 textColor-blue text-center q-mb-xl">
    ...
    <div id="campaigns-tabs" class="flex justify-center q-mt-md">
      ...
      >
        <q-tab
          name="all"
          label="Todos"
          class="text-white q-px-xl campaigns-tabs-tab"
        />
        <q-tab
          name="campaigns"
          label="Campanhas"
      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel name="all">
          ...
          <div class="campaigns-cards">
            <!-- Row -->
            <div id="campaigns-row" class="row justify-around q-mb-xl">
              <!-- Organization -->
              <div
                class="campaigns-row-card text-center text-red col-sm-4 col-md-2 q-mx-sm q-mb-md"
              >
                <p class="text-h6">
        ...
        <q-tab-panel name="charityEvents">
          <!-- Cards -->
          <div class="campaigns-cards">
            <!-- Row -->
            <div id="campaigns-row" class="row justify-around q-mb-xl">
